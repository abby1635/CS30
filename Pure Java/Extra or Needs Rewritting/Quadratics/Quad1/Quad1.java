public class Quad1 {
  ...
  public static void main (String[] args) {
    ...
    System.out.println(stringA + stringB + stringC); //Result should concatinate
    ...
    System.out.println(numA + numB + numC); //Result should sum three numbers
    ...
    System.out.println(Double.isNaN(sqroot)); //Returns true if TRUE
  }
}
//Need args Exception
